...
void ofxCustomPixelRing::setup(int circleSize,int radius, int shiftX, int shiftY, int spacing)
{
    size = circleSize;
...
void ofxCustomPixelRing::drawSampleRegion(bool hideArea)//, ofMesh mesh, vector<ofPoint> pos)
{
    if (hideArea == true) {
...
//--------------------------------------------------------------
void ofxCustomPixelRing::ledObject()
{
    ofFill();
    ofSetColor(100,175);
...
//--------------------------------------------------------------
void ofxCustomPixelRing::draw(int x, int y)
{
...
int ofxCustomPixelRing::circleSize()
{
    return size;
}
