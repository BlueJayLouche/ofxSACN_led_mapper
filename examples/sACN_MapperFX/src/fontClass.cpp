...
//  sACN_Mapper
//
//  Created by administrator on 23/7/21.
//

#include "fontClass.hpp"
void fontClass::setup(uint32_t letter, int size, int spacing, glm::vec2 position)
{
    _size = size;
...
//--------------------------------------------------------------
vector<glm::vec2> fontClass::getPosition()
{
    return pos;
}//--------------------------------------------------------------
int fontClass::circleSize()
{
    return _size;
}
